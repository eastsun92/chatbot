...
def chat_kakao():
    ...
    future = executor.submit(ctChat.send_request)    
    try:
        ...
        ctChat.add_response(response_from_openai)
        response_to_kakao = format_response(ctChat.get_response_content(), useCallback=False)
